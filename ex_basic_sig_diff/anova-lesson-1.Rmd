...
Using the fitted anova model, `iris.aov`, from the previous section, we can use the `plot()` function in `R` to automatically prepare some diagnostic plots.  For this particular assumption, we only care about the first plot.
...
plot_resids_anova(Sepal.Width~Species,iris)
